    ...
    <div id="page_main" class="clearfix">
        <div class="page-right">
            <div class="site-nav"><span>当前位置 : </span><a href=".">公司主页</a> &gt;&gt; <a
                    href="indexmethod!zhaopinlist.action" title="招聘信息">留言反馈</a>&gt;&gt;留言详情
            </div>
            <div class="page-single">
                <p style="LINE-HEIGHT: 25px">
                 <input class="button" type="button" value="返回" onclick="javascript:history.go(-1);"/><br/>
                    
                 	   留言内容：${message.neirong }<br/>

                   	 留言时间：${message.shijian }<br/>

                 	  留言人：${message.xingming} <br/>

                  	  回复内容：${message.reply}<br/>
                </p>
            </div>
        </div>
