...
<!-- js图片和图片得文字说明 -->
  ...
  <div id="page_main" class="clearfix">
    <div class="page-right">
      <div class="site-nav"><span>当前位置 : </span><a href=".">公司主页</a> &gt;&gt; <a href="indexmethod!xinwenlist.action" title="留言反馈">留言反馈</a></div>
      <div class="page-news">
          &nbsp;&nbsp;<input type="button" value="添加留言" onclick="window.location.href='indexmethod!messageadd.action'"/>
          &nbsp;&nbsp;&nbsp;&nbsp;<input class="button" type="button" value="返回" onclick="javascript:history.go(-1);"/><br/><br/> 
      <table border="0" align="center">
      <tr><th class="news-title">留言内容</th><th class="news-time">日期</th></tr>
<c:forEach items="${list}"  var="message">

<tr><td align="center"><a href="indexmethod!messagedetail.action?id=${message.id }" >${message.neirong }</a></td><td class="time-list"><span>${fn:substring(message.shijian,0, 10)}</span></td></tr>
</c:forEach>
      </table>
