...
<div id="wrapper">
 ...
 <div id="MainMenu" class="ddsmoothmenu">
    <ul>
      ...
      <li><a href="indexmethod!xinwenlist.action" title="新闻中心" id="menu_selected"><span>新闻中心</span></a></li>
...
<tr><td class="time-list"><span>${fn:substring(message.createtime,0, 10)}</span></td><td align="center"><a href="indexmethod!xinwen.action?id=${message.id }" >${message.biaoti }</a></td></tr>
</c:forEach>
      </table>
